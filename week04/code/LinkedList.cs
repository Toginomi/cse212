...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        else
        {
            ...
            newNode.Prev = _tail; // Connect new node backward to the old tail
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the pointer is at the head
                if (curr == _head)
                {
                    RemoveHead(); // Reuse existing logic for removing head
                }
                // If the pointer is at the tail
                else if (curr == _tail)
                {
                    RemoveTail(); // Reuse existing logic for removing tail
                }
                // Else
                else
                {
                    curr.Prev!.Next = curr.Next; // Connect node before 'value' forward to node after 'value'
                    curr.Next!.Prev = curr.Prev; // Connect node after 'value' backward to node before 'value'
                }

                return; // Exit after removing the first match
            }

            curr = curr.Next; // Continue searching forward
        }
    }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        // Start at the head and search forward through the list.
        Node? curr = _head;
        while (curr is not null)
        {
